...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_MS_U,            U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_MS_L,            U_MS_D,            U_MS_R,            U_PST,             U_NU,              \
...
U_NA,              U_NA,             &ac_eacu,           U_NA,              U_NA,              U_NA,              &ac_uacu,          &ac_iacu,         &ac_oacu,           U_NA,              \
&ac_aacu,          U_NA,             U_NA,               &kp LSHFT,         U_NA,              U_NA,              &kp LSHFT,         U_NA,             U_NA,               U_NA,              \
U_NA,              U_NA,             U_NA,               U_NA,              U_NA,              U_NA,              U_NA,              U_NA,             U_NA,               U_NA,              \
U_NP,              U_NP,             U_NA,               U_NA,              U_NA,              U_NA,              U_NA,              U_NA,             U_NP,               U_NP
